...
// This route handles PayU POST callbacks and redirects to the success page
export async function POST(request: NextRequest) {
  try {
    if (process.env.NODE_ENV === 'development') {
      console.log('PayU success callback received at /donate/payu-success');
    }
...
export async function GET(request: NextRequest) {
  if (process.env.NODE_ENV === 'development') {
    console.log('GET request to /donate/payu-success - redirecting to success page');
  }
