...
export default function EventBookingClient({ eventData }: EventBookingClientProps) {
  ...
  return (
    <>
      ...
      {!isLoading && (
        <ComponentErrorBoundary componentName="Event Booking">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-center gap-2 text-brand-earthen col-span-2 md:col-span-1">
                        ...
                        <div className="min-w-0">
                          <p className="font-medium whitespace-normal break-words leading-snug">Only 100 tickets • First-come, first-served</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="space-y-4 text-brand-earthen">
                        <div>
                          <h4 className="font-bold text-brand-red mb-2">Sofa Seating & Selection</h4>
                          <ul className="list-disc list-inside space-y-1 text-sm">
                            <li>Exclusive Sofa Seating zone (Only 100 seats available)</li>
                            <li>All seats are allocated on a first-come, first-served basis</li>
                            <li>Seat availability is shown in real-time</li>
                            <li>Tickets are valid for a single day (date of purchase)</li>
                          </ul>
                        </div>
                        
                        <div>
                          <h4 className="font-bold text-brand-red mb-2">Access & Benefits</h4>
                          <ul className="list-disc list-inside space-y-1 text-sm">
                            <li>Free Village Entry: Access to the entire festival village</li>
                            <li>Dedicated Entry Gate to the Sofa Zone</li>
                            <li>Complimentary Snacks included</li>
                            <li>BookMyShow launch soon; booking will be on BMS</li>
                          </ul>
                        </div>
                        ...
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 text-sm">
                            ...
                            <li>Tickets are non-refundable; transfers per platform policy</li>
                  ...
                  {currentStep === 1 && (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="lg:hidden flex overflow-x-auto overflow-y-hidden scrollbar-hide gap-4 pb-2" style={{ scrollSnapType: 'x mandatory', scrollBehavior: 'smooth', WebkitOverflowScrolling: 'touch' }}>
                          {seatingAreas.map((area, index) => {
                            ...
                            return (
                              <motion.div
                                ...
                                className={`relative bg-white rounded-3xl shadow-xl overflow-hidden border transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 flex flex-col group flex-shrink-0 w-80 ${
                                  isAvailable 
